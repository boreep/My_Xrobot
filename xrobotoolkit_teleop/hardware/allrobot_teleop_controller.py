...
from xrobotoolkit_teleop.common.base_robot_teleop_controller import RobotTeleopController
...
class AllRobotTeleopController(RobotTeleopController, Node):
    def __init__(
        self,
        ...
        Node.__init__(self, "allrobot_teleop_controller")
        super().__init__(
    ...
    def _robot_setup(self):
        self.get_logger().info("正在设置AllRobot机器人控制器...")
